...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="department"                data-endpoint="POSTapi-employees"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>employeeNumber</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="employeeNumber"                data-endpoint="POSTapi-employees"
               value="16"
               data-component="body">
    <br>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/employees/6821f85d09c072c4ea0f8322" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/employees/6821f85d09c072c4ea0f8322"
);
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="6821f85d09c072c4ea0f8322"
               data-component="url">
    <br>
<p>The ID of the employee. Example: <code>6821f85d09c072c4ea0f8322</code></p>
            </div>
                    </form>
...
<small>boolean</small>&nbsp;
 &nbsp;
                <label data-endpoint="PUTapi-employees--id-" style="display: none">
            <input type="radio" name="isManager"
                   value="true"
                   data-endpoint="PUTapi-employees--id-"
                   data-component="body"             >
            <code>true</code>
        </label>
        <label data-endpoint="PUTapi-employees--id-" style="display: none">
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="department"                data-endpoint="PUTapi-employees--id-"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="employeeNumber"                data-endpoint="PUTapi-employees--id-"
               value="16"
               data-component="body">
    <br>
<p>Example: <code>16</code></p>
